...
$result = mysqli_query($connection, "INSERT INTO registerakun (username, email, psw) VALUES ('$username', '$email', '$psw')"); // Melakukan query untuk memasukkan data baru ke tabel 'registerakun'.
